...
###--------------------------------------------------------------------------###
### Curvas de sobrevivencia mediante método KM
###--------------------------------------------------------------------------###
...
png("PFs.png") # Ajustar medidas para claidad de imagen
pfs_subtype_120m
dev.off()
...
tiff("output/distribuciones.tiff")
...
tiff("output/cluster_jerarquico.tiff")
plot(clus, main="Cluster Jerárquico", xlab="Patient")
dev.off()
